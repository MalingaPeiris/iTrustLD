    ...
    <div class="container firstContainer loyaltyContainer font">
        <div class="row">
            <div class="col-md-12" style="border-color: rgb(152,152,152);">
                <h1 class="text-danger fs-2">Withdraw Details</h1>
                <p class="text-white-50">Short description about Withdraw Details</p>
                ...
                <input type="hidden" name="withraw_type" id="withraw_type" value="' . $id . '">
                ...
                <div class="row my-3 p-3">
                    <div class="col-md-6 p-4 depositColumn">
                        ...
                        <div>
                            <div class="field">
                                <input type="number" id="withrawamttxt" name="withrawamttxt" onchange="change_amt()" required />
                                <label>Withdraw Amount</label>
                            </div>
                        </div>
                        <div>
                            <div class="field">
                                <input type="text" id="platformtxt" name="platformtxt" required />
                                <label>Platform Credentials</label>
                            </div>
                        </div>
                        <p class="mb-0 mt-4 text-white">Withdraw Amount:</p>
                        <div class="field depositAmount" id="RSrate_amt_lbl">
        ...
        <div class="row">
            <div class="col-md-12">
                <hr class="text-danger">
                    ...
                    <button class="btn btn-danger w-100 fw-bold" type="button" onclick="Image_fetch()">Next</button>
            </div>
        </div>
    </div>
    ';
