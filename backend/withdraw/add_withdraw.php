...
if ($_SESSION['userId']) {
    ...
    $withrawamttxt =  mysqli_real_escape_string($connect, $_POST['withrawamttxt']); //Lkr Amt
    ...
    $banktxt =  mysqli_real_escape_string($connect, $_POST['banktxt']);
    $branchtxt =  mysqli_real_escape_string($connect, $_POST['branchtxt']);
    $accountnotxt =  mysqli_real_escape_string($connect, $_POST['accountnotxt']);
    ...
    if (move_uploaded_file($tmp_name, $location)) {
        ...
        $doller_amt = calculate_amt($withrawamttxt, $newrate);
        ...
        $query = "INSERT INTO `withdraw_doller` (`id`, `userid`, `name`, `tran_id`, `lkramt`, `dolleramt`, `adminid`, `adminname`, `message`, `image`, `up_date`, `bankusername`, `bank`, `branch`, `account_no`, `status`, `subscription`) VALUES 
(NULL, '$userid', '$name', '$transaction_id', '$withrawamttxt', '$doller_amt', NULL, NULL, NULL, '$location', '$tans_date', '$usernametxt', '$banktxt', '$branchtxt', '$accountnotxt', '0', '$user_subcription');";
